...
const verifier = () => {
    // vérifier que les nombres saisis sont bien des nombres 1 à 9

    //Récupérer tous les input de la page
    const listeInput = document.querySelectorAll('input')

    // enlever toutse le classes invalides
        ...
        for (let col = 0; col < 9; col++) {
           ...
           if (valeur === '') {
            ...
            if (valeurExiste) {
                ...
                console.log('ligne ' + ligne + ' incorrecte:' + anomalie)
...
//Assigner l'événemenyt click à la function vérifier
